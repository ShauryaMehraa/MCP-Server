...
TIMEOUT_SECONDS = float(os.getenv("SOILHEALTH_TIMEOUT_SECONDS", os.getenv("AGMARKNET_TIMEOUT_SECONDS", "30")))
MAX_RETRIES = int(os.getenv("SOILHEALTH_MAX_RETRIES", os.getenv("AGMARKNET_MAX_RETRIES", "3")))
INITIAL_BACKOFF = float(os.getenv("SOILHEALTH_INITIAL_BACKOFF", os.getenv("AGMARKNET_INITIAL_BACKOFF", "0.5")))

MCP_TRANSPORT = os.getenv("SOILHEALTH_MCP_TRANSPORT", os.getenv("MCP_TRANSPORT", "streamable-http")).strip().lower()
MCP_HOST = os.getenv("SOILHEALTH_MCP_HOST", os.getenv("MCP_HOST", "0.0.0.0")).strip()
MCP_PORT = int(os.getenv("SOILHEALTH_MCP_PORT", "9005"))
MCP_MOUNT_PATH = os.getenv("SOILHEALTH_MCP_MOUNT_PATH", os.getenv("MCP_MOUNT_PATH", "/")).strip() or "/"
